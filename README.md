...
**Latest release: [v0.17.1](https://github.com/SreerajSK990/script-mc-launcher/releases/tag/v0.17.1)** — unified shader browsing, drag-and-drop ZIP installer, non-blocking environment detection, and cohesive instance detail navigation. Read the [release notes](release-notes/v0.17.1.md) for details.
...
- **Unified Shader Browser & Manager:** Dedicated first-class Shaders tab in the Mod Browser alongside Mods, Resource Packs, and Modpacks with unified title, subtitle, target instance selector, and Browse / Installed subtabs. Browse shader projects from Modrinth or CurseForge with interactive cards, inspect descriptions, change versions, import shader ZIPs via file picker or drag-and-drop, and manage packs in each instance's isolated `shaderpacks/` folder. Non-blocking detection of Iris, Oculus, and OptiFine with one-click setup of Iris or Oculus. Select the active shader inside Minecraft. Vanilla instances first need a compatible mod-loader setup through Installation settings.
